...
def run(test, params, env):
    ...
    login_timeout = params.get_numerict("login_timeout", "360")
    check_pci_diff = "yes" == params.get("check_pci_diff", "no")
    detach_interface = "yes" == params.get("detach_interface", "no")
    ...
    try:
        ...
        if test_scenario == "pci_diff_detach":
            ...
            if detach_interface:
                ...
                libvirt.check_exit_status(detach_result, expect_error=False)
                ...
                logging.info("Successfully verified interface removal from both XMLs")
