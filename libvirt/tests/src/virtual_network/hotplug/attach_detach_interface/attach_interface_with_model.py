...
def check_model_controller(vm_name, pci_model, test):
    ...
    test.test.log.debug(f"Interface xml after vm started:\n{iface}")
    ...
    test.test.log.debug(f"Controller xml:\n{iface_controller}")

    if iface_controller.model == pci_model:
        test.test.log.debug("XML controller model check: PASS")
    else:
...
def run(test, params, env):
    ...
    try:
        ...
        test.test.log.debug(iface.fetch_attrs())
