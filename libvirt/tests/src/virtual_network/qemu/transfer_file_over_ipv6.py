...
def run(test, params, env):
    ...
    filesize = params.get_numeric("filesize", "4096")
    ...
    # prepare test data
    guest_path = "{0}src-{1}".format(tmp_dir, utils_misc.generate_random_string(8))
    dest_path = "{0}dst-{1}".format(tmp_dir, utils_misc.generate_random_string(8))
