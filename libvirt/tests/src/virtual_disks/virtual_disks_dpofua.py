...
def run(test, params, env):
    ...
    def setup_guest():
        ...
        """
        if with_hotplug:
            test.log.info("SETUP_TEST:Prepare hotplugged disk xml with dpofua disk.")
            ...
            test.log.info("SETUP_TEST: Prepare the guest xml with dpofua disk.")
    ...
    try:
        test.log.info("STEP_TEST: Start the guest.")
