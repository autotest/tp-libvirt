...
def run(test, params, env):
    ...
    def setup_blk_dev():
        ...
        libvirt.setup_or_cleanup_iscsi(True, image_size='3G')
        # create 2nd scsi disk
        libvirt.create_scsi_disk(scsi_option="", scsi_size="3072")
    ...
    def run_same_target():
        ...
        :return: None
        """
        blk_dev1, blk_dev2 = setup_blk_dev()
