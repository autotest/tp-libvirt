...
def adjust_virtio_size(params):
    ...
    unplug_target_size = _convert_size(unplug_target_size, unplug_size_unit)
    unplug_request_size = _convert_size(unplug_request_size, unplug_request_unit)
...
def check_source_and_addr_xml(test, params, virtio_mem_xml):
    ...
    source_dict = params.get("source_dict", "")
    expected_source_pgsize = memory.get_huge_page_size()
